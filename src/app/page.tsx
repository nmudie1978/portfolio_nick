      ...
      <main id="main" className="flex-1">
        <Container className="pt-16 pb-24 md:pt-28">
          ...
          <h1 className="t-h1 mt-4 max-w-[16ch]">
            {person.name} — three design directions.
          </h1>
          <p className="t-lead measure mt-6">
            Same content, same six sections, eight visual systems. Open each on
            desktop and phone; the chosen direction becomes the site.
          </p>

          {[
            {
              title: "Dark editorial",
              ids: VARIANT_IDS.filter((id) => id === "a" || id === "b"),
            },
            {
              title: "Light family — Marine Foam structure, six tones",
              ids: VARIANT_IDS.filter((id) => id !== "a" && id !== "b"),
            },
          ].map((group) => (
                    ...
                    <li key={id}>
                      ...
                      >
                        ...
                        <span className="flex flex-col gap-1">
                          <span className="t-h3 text-paper transition-colors group-hover:text-copper">
                            {v.name}
                          </span>
                          <span className="t-meta text-paper-3">
                            {v.tagline}
                          </span>
                        </span>
                        <span className="t-body col-start-2 text-paper-2 md:col-start-3">
                          {v.description}
                        </span>
